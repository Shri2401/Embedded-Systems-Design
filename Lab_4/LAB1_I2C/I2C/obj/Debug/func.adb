M:func
F:G$Init_Serial$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$putchar$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$getchar$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$putstr$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$getstr$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lfunc.putchar$c$1_0$71({1}SC:U),F,0,0
S:Lfunc.putstr$s$1_0$75({3}DG,SC:U),F,0,0
S:Lfunc.putstr$i$1_0$76({2}SI:S),F,0,0
S:Lfunc.getstr$num$1_0$78({6}DA3d,SI:U),F,0,0
S:Lfunc.getstr$size_num$1_0$78({2}SI:U),F,0,0
S:Lfunc.getstr$i$2_0$79({2}SI:S),F,0,0
...
S:Ffunc$__str_0$0_0$0({32}DA32d,SC:U),D,0,0
S:Ffunc$__str_1$0_0$0({23}DA23d,SC:U),D,0,0
S:Ffunc$__str_2$0_0$0({67}DA67d,SC:U),D,0,0
