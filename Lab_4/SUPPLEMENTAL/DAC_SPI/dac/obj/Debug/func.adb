M:func
F:G$Init_Serial$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$putchar$0_0$0({2}DF,SI:S),C,0,0,0,0,0
F:G$getchar$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$putstr$0_0$0({2}DF,SI:S),C,0,0,0,0,0
F:G$getstr$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$get_number1$0_0$0({2}DF,SI:S),C,0,0,0,0,0
F:G$get_number2$0_0$0({2}DF,SI:S),C,0,0,0,0,0
S:Lfunc.putchar$c$1_0$71({2}SI:S),F,0,0
S:Lfunc.putstr$s$1_0$75({3}DG,SC:U),F,0,0
S:Lfunc.putstr$i$1_0$76({2}SI:S),F,0,0
S:Lfunc.getstr$s$1_0$78({3}DG,SC:U),F,0,0
S:Lfunc.getstr$temp$1_0$79({3}DG,SC:U),F,0,0
S:Lfunc.getstr$c$1_0$79({2}SI:S),F,0,0
S:Lfunc.get_number1$a$1_0$84({2}SI:U),F,0,0
S:Lfunc.get_number1$size1$1_0$84({2}SI:S),F,0,0
S:Lfunc.get_number2$a$1_0$91({4}DA2d,SI:U),F,0,0
S:Lfunc.get_number2$size1$1_0$91({2}SI:U),F,0,0
S:Lfunc.get_number2$i$2_0$92({2}SI:S),F,0,0
...
S:G$serial_interrupt_handler$0_0$0({2}DF,SV:S),C,0,0
S:G$serial_putc$0_0$0({2}DF,SV:S),C,0,0
S:G$serial_getc$0_0$0({2}DF,SC:U),C,0,0
S:G$autobaud$0_0$0({2}DF,SV:S),C,0,0
...
S:G$get_number1$0_0$0({2}DF,SI:S),C,0,0
S:G$get_number2$0_0$0({2}DF,SI:S),C,0,0
S:Ffunc$__str_0$0_0$0({20}DA20d,SC:U),D,0,0
S:Ffunc$__str_1$0_0$0({26}DA26d,SC:U),D,0,0
S:Ffunc$__str_2$0_0$0({44}DA44d,SC:U),D,0,0
S:Ffunc$__str_3$0_0$0({34}DA34d,SC:U),D,0,0
S:Ffunc$__str_4$0_0$0({26}DA26d,SC:U),D,0,0
