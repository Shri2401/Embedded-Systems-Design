...
;------------------------------------------------------------
;n                         Allocated with name '_delay_n_65536_14'
;------------------------------------------------------------
	G$delay$0$0 ==.
	C$main.c$7$0_0$15 ==.
;	main.c:7: void delay(int n)
;	-----------------------------------------
;	 function delay
;	-----------------------------------------
_delay:
...
_main:
	C$main.c$15$1_0$17 ==.
;	main.c:15: SPCON |= 0x30;               /* master mode */
	orl	_SPCON,#0x30
	C$main.c$16$1_0$17 ==.
;	main.c:16: P1_4 = 1;       /* enable master */
;	assignBit
	setb	_P1_4
	C$main.c$17$1_0$17 ==.
;	main.c:17: SPCON |= 0x82;              /* Fclk Periph/128 */
	orl	_SPCON,#0x82
	C$main.c$18$1_0$17 ==.
;	main.c:18: SPCON &= ~0x08;         /* CPOL=0; transmit mode example */
	anl	_SPCON,#0xf7
	C$main.c$19$1_0$17 ==.
;	main.c:19: SPCON |= 0x04;            /* CPHA=1; transmit mode example */
	orl	_SPCON,#0x04
	C$main.c$20$1_0$17 ==.
;	main.c:20: SPCON |= 0x40;     /* run SPI */
	orl	_SPCON,#0x40
	C$main.c$23$1_0$17 ==.
;	main.c:23: while(1)
00126$:
...
;	assignBit
	clr	_P1_4
	C$main.c$26$2_0$18 ==.
;	main.c:26: SPDAT = 0X12;
	mov	_SPDAT,#0x12
	C$main.c$27$2_0$18 ==.
;	main.c:27: while(!(SPSTA & 0x80));
00101$:
	mov	a,_SPSTA
	jnb	acc.7,00101$
	C$main.c$28$2_0$18 ==.
;	main.c:28: SPDAT = 0X20;
	mov	_SPDAT,#0x20
	C$main.c$29$2_0$18 ==.
;	main.c:29: while(!(SPSTA & 0x80));
00104$:
	mov	a,_SPSTA
	jnb	acc.7,00104$
	C$main.c$30$2_0$18 ==.
...
;	assignBit
	clr	_P1_4
	C$main.c$34$2_0$18 ==.
;	main.c:34: SPDAT = 0X18;
	mov	_SPDAT,#0x18
	C$main.c$35$2_0$18 ==.
;	main.c:35: while(!(SPSTA & 0x80));
00107$:
	mov	a,_SPSTA
	jnb	acc.7,00107$
	C$main.c$36$2_0$18 ==.
;	main.c:36: SPDAT = 0X80;
	mov	_SPDAT,#0x80
	C$main.c$37$2_0$18 ==.
;	main.c:37: while(!(SPSTA & 0x80));
00110$:
	mov	a,_SPSTA
	jnb	acc.7,00110$
	C$main.c$38$2_0$18 ==.
...
;	assignBit
	clr	_P1_4
	C$main.c$42$2_0$18 ==.
;	main.c:42: SPDAT = 0X12;
	mov	_SPDAT,#0x12
	C$main.c$43$2_0$18 ==.
;	main.c:43: while(!(SPSTA & 0x80));
00113$:
	mov	a,_SPSTA
	jnb	acc.7,00113$
	C$main.c$44$2_0$18 ==.
;	main.c:44: SPDAT = 0X20;
	mov	_SPDAT,#0x20
	C$main.c$45$2_0$18 ==.
;	main.c:45: while(!(SPSTA & 0x80));
00116$:
	mov	a,_SPSTA
	jnb	acc.7,00116$
	C$main.c$46$2_0$18 ==.
...
;	assignBit
	clr	_P1_4
	C$main.c$51$2_0$18 ==.
;	main.c:51: SPDAT = 0x00;
	mov	_SPDAT,#0x00
	C$main.c$52$2_0$18 ==.
;	main.c:52: while(!(SPSTA & 0x80));
00119$:
	mov	a,_SPSTA
	jnb	acc.7,00119$
	C$main.c$53$2_0$18 ==.
;	main.c:53: SPDAT = 0x00;
	mov	_SPDAT,#0x00
	C$main.c$54$2_0$18 ==.
;	main.c:54: while(!(SPSTA & 0x80));
00122$:
	mov	a,_SPSTA
	jnb	acc.7,00122$
	C$main.c$55$2_0$18 ==.
...
;	assignBit
	setb	_P1_4
	C$main.c$56$2_0$18 ==.
;	main.c:56: delay(100000);
	mov	dptr,#0x86a0
	lcall	_delay
	C$main.c$58$2_0$18 ==.
;	main.c:58: delay(1000000);
	mov	dptr,#0x4240
	lcall	_delay
	ljmp	00126$
	C$main.c$61$1_0$17 ==.
