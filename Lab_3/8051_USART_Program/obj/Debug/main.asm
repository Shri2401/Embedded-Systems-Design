...
;	main.c:57: Serial_Init();
	lcall	_Serial_Init
	C$main.c$61$1_1$47 ==.
;	main.c:61: heap1 = getinp_48_4800();
	lcall	_getinp_48_4800
	mov	r6,dpl
	mov	r7,dph
	mov	dptr,#_heap1
	mov	a,r6
	...
	movx	@dptr,a
	C$main.c$63$1_1$47 ==.
;	main.c:63: buffer_0 = (char*) malloc(heap1); // mallocs number of bytes and stores in Buffer_0
	mov	dpl,r6
	mov	dph,r7
	lcall	_malloc
	mov	r6,dpl
...
00102$:
	C$main.c$72$1_1$47 ==.
;	main.c:72: buffer_1 = (char *)malloc(heap1); // mallocs number of bytes and stores in Buffer_1
	mov	dptr,#_heap1
	movx	a,@dptr
	mov	r6,a
	inc	dptr
