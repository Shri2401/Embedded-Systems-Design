...
;	buffer_inputs.c:90: }
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'getinp_30_300'
;------------------------------------------------------------
;d1_1                      Allocated with name '_getinp_30_300_d1_1_65536_52'
;d1_2                      Allocated with name '_getinp_30_300_d1_2_65536_52'
;d1_3                      Allocated with name '_getinp_30_300_d1_3_65536_52'
;new_heapsize              Allocated with name '_getinp_30_300_new_heapsize_65536_52'
;x                         Allocated with name '_getinp_30_300_x_65537_53'
;y                         Allocated with name '_getinp_30_300_y_65538_54'
;z                         Allocated with name '_getinp_30_300_z_65539_55'
;------------------------------------------------------------
	G$getinp_30_300$0$0 ==.
	C$buffer_inputs.c$98$1_4$52 ==.
;	buffer_inputs.c:98: unsigned int getinp_30_300()
;	-----------------------------------------
;	 function getinp_30_300
;	-----------------------------------------
_getinp_30_300:
...
;	buffer_inputs.c:127: if ((new_heapsize>=30)&&(new_heapsize<=300))
	mov	ar4,r6
	mov	ar5,r7
	clr	c
	mov	a,r4
