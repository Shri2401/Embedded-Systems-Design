M:func
F:G$Serial_Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$PWM_Start_Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$PWM_Stop_Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Highspeed_Toggle_Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Watchdog_Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$getchar$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$putchar$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
S:Lfunc.putchar$c$1_0$85({2}SI:S),F,0,0
